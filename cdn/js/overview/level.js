(async () => {
    ...
    background.onload = () => {
        ...
        ctx.strokeText((params.get("member") || "redeye").toUpperCase(), properties.username.x || 0, properties.username.y || 0); // Write the member's name
        ...
        pdpbot.src = "/cdn/img/Logo/RedEye_Rounded.png";
        pdpbot.onload = () => {
        ...
        const pdp = new Image();
        pdp.src = params.get("avatar") || "/cdn/img/Logo/RedEye_Rounded.png";
        pdp.onload = () => {
            ctx.beginPath(); // Create a new path
