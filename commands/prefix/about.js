        ...
        try {
            const embed = new Discord.EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: "<:owner:1200816888364683396> __**Owner:**__", value: `${guild.members.cache.find(member => member.id === guild.ownerId).user.username} (id: ${guild.members.cache.find(member => member.id === guild.ownerId).id})`},
