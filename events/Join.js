...
//         try {
//             const channelId = require("../components/database").get(`/${member.guild.id}/channels/welcome`);
//             if (
...
//             const role = require("../components/database").get(`/${member.guild.id}/autorole`);
//             if (
//                 typeof role !== "object" &&
//                 member.guild.roles.cache.find(r => r.id === role.id) &&
//                 member.guild.roles.cache.find(r => r.id === role.id).editable &&
//                 member.manageable
//             ) {
